...
### 集約シート: `{owner/repo} - コーディング時間`

**日付ごとの統計**（トレンド分析用）

| 日付 | Issue数 | 平均 (時間) | 中央値 | 最小 | 最大 | 記録日時 |
|------|---------|-------------|--------|------|------|---------|
| 2024-01-10 | 4 | 6.5 | 4.0 | 1.0 | 24.0 | 2024-01-15 12:00 |
| 2024-01-11 | 3 | 8.2 | 6.0 | 2.0 | 18.0 | 2024-01-15 12:00 |

### 詳細シート: `{owner/repo} - コーディング時間 - Details`
...
| #124 | Bug Fix | owner/repo | 2024-01-11T09:00 | 2024-01-11T15:00 | #126 | 6.0 |
